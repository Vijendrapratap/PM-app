...
const Dashboard = () => {
  ...
  return (
    <div className="animate-fade-in dashboard-compact">
      ...
      <section className="attention-card section-card" id="attention"><div className="section-card-header"><div className="section-card-title"><AlertTriangle size={15}/>Attention Needed</div><span>Missed work, blockers and delivery pressure</span></div><div className="dashboard-signal-grid">
